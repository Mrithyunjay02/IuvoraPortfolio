      ...
      <div className="portfolio-container space-y-32 sm:space-y-40 lg:space-y-48 pb-32">
        ...
        <section className="space-y-28 lg:space-y-36">
          ...
          <div id="challenge" className="scroll-mt-28 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            <div className="lg:col-span-4 space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-amber-400/90 uppercase tracking-wider">
            ...
            <div className="lg:col-span-8 space-y-6">
              <p className="text-xl sm:text-2xl lg:text-3xl text-zinc-300 font-light leading-relaxed">
          ...
          <div id="solution" className="scroll-mt-28 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            <div className="lg:col-span-4 space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#2f7bff]/10 border border-[#2f7bff]/30 text-xs font-mono text-[#5b9aff] uppercase tracking-wider">
            ...
            <div className="lg:col-span-8 space-y-6">
              <p className="text-xl sm:text-2xl lg:text-3xl text-zinc-200 font-light leading-relaxed">
                {project.solution || project.description}
              </p>
              <div className="pt-4 flex items-center gap-2 text-xs font-mono text-[#5b9aff]">
          ...
          <section id="features" className="scroll-mt-28 space-y-12 sm:space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              {project.features.map((feature, idx) => (
                <div
                  key={idx}
                  className="p-8 sm:p-10 rounded-3xl bg-[#08080c] border border-white/10 hover:border-white/20 transition-all duration-300 space-y-4 group"
                >
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-xs font-semibold text-[#2f7bff] tracking-widest">
                      {`// 0${idx + 1}`}
                    </span>
                    <span className="w-2 h-2 rounded-full bg-white/10 group-hover:bg-[#2f7bff] transition-colors" />
                  </div>
                  <h3 className="text-xl sm:text-2xl font-semibold text-white tracking-tight group-hover:text-[#5b9aff] transition-colors">
                    {feature.title}
                  </h3>
          ...
          <section className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.map((tech) => (
                <div
                  key={tech}
                  className="inline-flex items-center gap-2.5 px-5 py-3 rounded-xl bg-[#08080c] border border-white/10 text-sm font-mono text-zinc-300 hover:text-white hover:border-[#2f7bff]/50 transition-colors"
                >
        ...
        <section id="process" className="scroll-mt-28 space-y-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="p-8 rounded-3xl bg-[#08080c] border border-white/10 space-y-4">
              <div className="flex items-center justify-between">
                <span className="font-mono text-xs uppercase tracking-widest text-[#2f7bff]">
                  Phase 01
                </span>
                <Compass className="w-5 h-5 text-zinc-500" />
              </div>
              <h3 className="text-lg font-semibold text-white">Discovery &amp; Scope</h3>
            ...
            <div className="p-8 rounded-3xl bg-[#08080c] border border-white/10 space-y-4">
              ...
              <h3 className="text-lg font-semibold text-white">UX &amp; Structure</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-[#08080c] border border-white/10 space-y-4">
              ...
              <h3 className="text-lg font-semibold text-white">Visual Design System</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-[#08080c] border border-white/10 space-y-4">
              ...
              <h3 className="text-lg font-semibold text-white">QA &amp; Verification</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 rounded-3xl bg-[#08080c] border border-white/10 space-y-4">
              ...
              <h3 className="text-lg font-semibold text-white">Production Deployment</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
        ...
        <section id="outcome" className="scroll-mt-28 py-16 sm:py-20 border-y border-white/10 space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-[#5b9aff] uppercase tracking-wider">
            <span>07 · Delivery Outcome</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white leading-tight max-w-4xl">
            Delivering Qualitative Impact &amp; Long-Term Digital Value
          </h2>
          <p className="text-xl sm:text-2xl text-zinc-300 font-light leading-relaxed max-w-4xl">
            {project.outcome ||
        ...
        <section className="relative rounded-3xl bg-[#08080c] border border-white/10 p-8 sm:p-14 lg:p-18 overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-7 py-4 rounded-xl font-medium text-sm bg-[#2f7bff] text-white hover:bg-[#5b9aff] transition-all duration-300 shadow-[0_0_30px_rgba(47,123,255,0.35)] cursor-pointer"
                >
                ...
                <Link
                  href="/#gallery"
                  className="inline-flex items-center gap-2.5 px-6 py-4 rounded-xl font-mono text-xs uppercase tracking-wider bg-white/5 hover:bg-white/10 text-zinc-300 hover:text-white border border-white/10 hover:border-white/20 transition-all duration-300"
                >
            ...
            <div className="lg:col-span-5 space-y-4">
              <a
                ...
                className="flex items-center justify-between p-5 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-white/20 hover:bg-white/[0.06] transition-all group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 rounded-xl bg-white/5 flex items-center justify-center text-[#2f7bff]">
