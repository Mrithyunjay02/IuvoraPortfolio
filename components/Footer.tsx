      ...
      <div className="portfolio-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-zinc-400 mb-6 uppercase tracking-wider">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-7 py-4 rounded-xl font-medium text-sm bg-[#2f7bff] text-white hover:bg-[#5b9aff] transition-all duration-300 shadow-[0_0_30px_rgba(47,123,255,0.35)] cursor-pointer"
            >
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/15 text-xs text-zinc-300 hover:text-white transition-colors"
                >
                  LinkedIn ↗
                </a>
                <a
