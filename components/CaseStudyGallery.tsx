...
export default function CaseStudyGallery({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-10">
        {images.map((src, idx) => (
          <div
            ...
            className="group relative rounded-3xl bg-[#09090d] dark:bg-[#09090d] light:bg-white border border-white/10 dark:border-white/10 light:border-black/10 hover:border-[#2f7bff]/40 dark:hover:border-[#2f7bff]/40 light:hover:border-[#1964eb]/40 overflow-hidden shadow-2xl light:shadow-[0_12px_40px_rgba(0,0,0,0.08)] transition-all duration-500 cursor-zoom-in"
          >
            {isPrototype ? (
              <div className="relative w-full py-16 sm:py-24 px-4 bg-[#050507] dark:bg-[#050507] light:bg-[#f5f6fa] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-grid-pattern opacity-40" />
                <div className="absolute w-96 h-96 bg-[#2f7bff]/15 dark:bg-[#2f7bff]/15 light:bg-[#1964eb]/10 rounded-full blur-[100px] pointer-events-none" />
              ...
              <div className="relative w-full aspect-[16/10] bg-[#050507] dark:bg-[#050507] light:bg-[#f5f6fa] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 dark:from-black/40 light:from-black/20 via-transparent to-transparent pointer-events-none" />
              </div>
            )}

            {/* Hover Expand Cue */}
            <div className="absolute bottom-5 right-5 flex items-center gap-2 px-3.5 py-2 rounded-full bg-black/60 dark:bg-black/60 light:bg-white/90 backdrop-blur-md border border-white/15 dark:border-white/15 light:border-black/10 text-xs font-mono text-white dark:text-white light:text-zinc-900 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
              <Maximize2 className="w-3.5 h-3.5 text-[#5b9aff] dark:text-[#5b9aff] light:text-[#1964eb]" />
      ...
      {selectedIdx !== null && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 dark:bg-black/95 light:bg-[#0a0b0f]/96 backdrop-blur-2xl p-4 sm:p-8 animate-in fade-in duration-200"
          role="dialog"
          aria-modal="true"
