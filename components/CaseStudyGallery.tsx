      ...
      <div className="grid grid-cols-1 gap-10">
        {images.map((src, idx) => (
          <div
            ...
            className="group relative rounded-3xl bg-[#09090d] border border-white/10 hover:border-[#2f7bff]/40 overflow-hidden shadow-2xl transition-all duration-500 cursor-zoom-in"
          >
            {isPrototype ? (
              <div className="relative w-full py-16 sm:py-24 px-4 bg-[#050507] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-grid-pattern opacity-40" />
                <div className="absolute w-96 h-96 bg-[#2f7bff]/15 rounded-full blur-[100px] pointer-events-none" />
            ...
            {/* Hover Expand Cue */}
            <div className="absolute bottom-5 right-5 flex items-center gap-2 px-3.5 py-2 rounded-full bg-black/60 backdrop-blur-md border border-white/15 text-xs font-mono text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
              <Maximize2 className="w-3.5 h-3.5 text-[#5b9aff]" />
